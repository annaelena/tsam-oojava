package anitoiu.mariana.exception;


class ControllaLampadina extends Exception {
	@Override
	...
	public class Lampadina {
		...
		public String switchOn() throws ControllaLampadina {
			if (++contaCicli == cicliMax)
				throw new ControllaLampadina();
