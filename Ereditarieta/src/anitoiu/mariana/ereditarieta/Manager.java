...
public class Manager extends Dipendente {
	...
	public int calcolaStipendio() {
		//stipendio è un attributo privato della classe Dipendente.
		//privato === non accessibile all'esterno delle classe che lo definisce
		//NOTA: l'oggetto Manager contiene lìattributo stipendio(e il suo valore)
		int tot = Math.round(getStipendio() +
			getStipendio() * getAnzianita()*1.2f);
		//bonus è privato, ma è accessibile perchè è definito all'interno dell stess classe(Manager)
