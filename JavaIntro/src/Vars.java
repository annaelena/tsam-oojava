...
public class Vars {
	...
	public static void main(String[] args) {
		...
		//boolean b3 = 0; // cannot int to boolean
		...
		//int = 3.2; // cannot convert double to int
		...
		//short s3 = 32768; //cannot int to byte(-32768 to 32767)
		...
		//String str4 = 5; //cannot int to string
		//String str5 = 'a'; //cannot convert chat to string
